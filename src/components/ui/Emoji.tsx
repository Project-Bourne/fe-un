...
export default function CustomEmoji({ toggleEmoji, selectedEmoji, closeEmojiDisplay }) {
    // handle emoji click 
 ...
 const emojiRef = useRef();
  ...
  return (
    <div className="fixed z-50 top-[10rem] md:top-[17.5rem] md:right-7 right-3 shadow-md" ref={emojiRef}>
