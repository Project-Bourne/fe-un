...
class Service {
    ...
    async createWorkspace(workspaceData) {
      try {
        const response = await request('/space/create-space', 'POST', workspaceData, true, false, false);
        return response;
      } catch (error) {
        throw error;
      }
    ...
    async deleteWorkspace(workspaceId) {
      try {
        await request(`/workspaces/${workspaceId}`, 'DELETE', {}, true, false, false);
      } catch (error) {
        throw error;
      }
    }
    ...
    async updateWorkspace(workspaceId, updatedData) {
      try {
        const response = await request(`/space/${workspaceId}`, 'PATCH', updatedData, true, false, false);
        return response;
      } catch (error) {
        throw error;
      }
    ...
    async getWorkspace() {
      try {
        const response = await request(`space/spaces/`, 'GET', {}, true, false, false);
 ...
 async createCollab(collabData) {
    try {
      const response = await request('/space/create-space', 'POST', collabData, true, false, false);
      return response;
    } catch (error) {
      throw error;
    }
