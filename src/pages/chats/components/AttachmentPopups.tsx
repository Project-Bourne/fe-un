    ...
    return(
        <>
            <div className="grid gap-y-3 bg-transparent absolute -mt-[7rem]">
                ...
                />
                <input type="file" className="hidden" ref={docRef} accept=".pdf, .docx, .txt, application/msword" multiple  />
                <input type="file" className="hidden" ref={imgRef} accept="image/*" multiple onChange={handleImageChange} />
            </div>
            <ImagesPreview 
