  ...
  return (
    ...
    <div className='w-full'>
        <div className='flex items-center border-b border-gray p-2'>
            <div className='flex items-center mr-2 text-[8px] text-gray-400 h-[26px] w-[106px] justify-center bg-white border-gray-300 border-2 p-1 rounded-full'>
            ...
            <input type="text" className='w-full h-full focus:outline-none' placeholder='Type phone number' />
        </div>
                ...
                <div className='flex  rounded-[1rem] mb-3 w-full bg-gray-100 hover:bg-sirp-primaryLess2 items-center cursor-pointer p-4 justify-between'>
                    <div className='text-sm flex items-center justify-start'>
                        ...
                        <div className='flex ml-4 flex-col items-start justify-center'>
                            ...
                            <span className='text-gray-400'>090302672**</span>
                        </div>

                    </div>
                    <div className='h-[20px] w-[20px] flex items-center justify-center'>
                        <input type="checkbox" name="" id="" className='w-full h-full border-[3px] border-gray-300'/>
                    </div>
                </div>
                <div className='flex  rounded-[1rem] mb-3 w-full bg-gray-100 hover:bg-sirp-primaryLess2 items-center cursor-pointer p-4 justify-between'>
                    <div className='text-sm flex items-center justify-start'>
