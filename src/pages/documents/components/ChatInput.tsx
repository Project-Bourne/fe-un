        ...
        <>
            ...
            <span className="font-bold">Invite Others</span>
                <form className="flex relative justify-center  flex-col mx-auto">
                    ...
                    <div
                        className="md:w-[10%] rounded-l-full border-r-0  bg-[#F9FBFE] focus:border-[#F9FBFE] outline-none flex justify-center">
                        <Image
                    ...
                    <div className="flex justify-between gap-x-1 md:gap-x-2  md:w-[12%] bg-[#F9FBFE] rounded-r-full">
                        <Image
                            ...
                            alt="send"
                            className={`${!isTyping ? 'bg-[#B9C1C7]' : 'bg-sirp-primary'} p-2 md:p-3 my-auto rounded-full h[40px] w-[40px] md:h-[50px] md:w-[50px] hover:cursor-pointer`}
